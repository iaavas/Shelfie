...
exports.createComment = exports.likePost = exports.deletePost = exports.updatePost = exports.getPost = exports.getAllPosts = exports.createPost = void 0;
...
exports.getPost = (0, handlerFactory_1.getOne)(post_1.default, 'comments');
...
exports.likePost = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (post.likedBy.includes(userId)) {
        const unlikedPost = yield post_1.default.findByIdAndUpdate(id, { $inc: { likes: -1 }, $pull: { likedBy: userId } }, { new: true });
        console.log("yeta");
    ...
    const updatedPost = yield post_1.default.findByIdAndUpdate(id, { $inc: { likes: 1 }, $push: { likedBy: userId } }, { new: true });
    return res.status(200).json({
        status: 'Liked',
        data: updatedPost
    });
...
exports.createComment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedPost = yield post_1.default.findByIdAndUpdate(id, { $push: { comments: comment } }, { new: true });
    return res.status(200).json({
        status: 'Liked',
        data: updatedPost
    });
